...
public class DashboardEditDialog extends BaseDialog {
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.dashboard_edit_dialog_create_info_label);
        }

        {
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_add_dialog_table_name, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dashboard_edit_dialog_database_label);
...
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_data_type_label, UIDashboardMessages.dashboard_edit_dialog_data_type_hint, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_calc_type_label, UIDashboardMessages.dashboard_edit_dialog_calc_type_hint, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_value_type_label, UIDashboardMessages.dashboard_edit_dialog_value_type_hint, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_interval_label, UIDashboardMessages.dashboard_edit_dialog_interval_hint, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.dashboard_edit_dialog_fetch_type_label, UIDashboardMessages.dashboard_edit_dialog_fetch_type_hint, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_add_dialog_table_description, CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
...

        {
            ...
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.dashboard_edit_dialog_queries_info);
...

        {
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_update_period_label, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
