...
public class DashboardItemConfigDialog extends BaseDialog {
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_info_group_label, 4, GridData.FILL_HORIZONTAL, 0);

            //UIUtils.createLabelText(infoGroup, "ID", dashboardConfig.getDashboardDescriptor().getId(), SWT.BORDER | SWT.READ_ONLY);
            UIUtils.createLabelText(infoGroup, UIDashboardMessages.dashboard_add_dialog_table_name, dashboardConfig.getDashboardDescriptor().getName(), SWT.BORDER | SWT.READ_ONLY)
                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));

            UIUtils.createControlLabel(infoGroup, UIDashboardMessages.dashboard_add_dialog_table_description).setLayoutData(new GridData(GridData.VERTICAL_ALIGN_BEGINNING));
            ...
            if (SHOW_QUERIES_BUTTON) {
                ...
                queriesButton.setText(UIDashboardMessages.dashboard_item_config_dialog_sql_queries_text);
                    ...
                    public void widgetSelected(SelectionEvent e) {
                        ...
                        if (serviceSQL != null) {
                            serviceSQL.openSQLViewer(
                                ...
                                UIDashboardMessages.dashboard_item_config_dialog_sql_viewer_title,
                                UIIcon.SQL_SCRIPT,
                                sql.toString(),
                                false, false);
                        }
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_update_group_label, 2, GridData.FILL_HORIZONTAL, 0);

            Text updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_update_period_label, String.valueOf(dashboardConfig.getUpdatePeriod()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
            ...
            Text maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.dashboard_edit_dialog_maximum_items_label, String.valueOf(dashboardConfig.getMaxItems()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
...
*/
        ...
        {
            Group viewGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.dashboard_item_config_dialog_dashboard_view_group_label, 2, GridData.FILL_HORIZONTAL, 0);

            Combo typeCombo = UIUtils.createLabelCombo(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_view_label, UIDashboardMessages.dashboard_item_config_dialog_dashboard_view_group_label, SWT.BORDER | SWT.READ_ONLY);
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_legend_checkbox, UIDashboardMessages.dashboard_item_config_dialog_legend_checkbox_hint, dashboardConfig.isLegendVisible(), 2)
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_grid_checkbox, UIDashboardMessages.dashboard_item_config_dialog_grid_checkbox_hint, dashboardConfig.isGridVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_domain_axis_checkbox, UIDashboardMessages.dashboard_item_config_dialog_domain_axis_checkbox_hint, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.dashboard_item_config_dialog_range_axis_checkbox, UIDashboardMessages.dashboard_item_config_dialog_range_axis_checkbox_hint, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
...
*/
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.dashboard_item_config_dialog_configuration_button, false).addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
