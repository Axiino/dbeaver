...
//        listViewer.getControl().setLayoutData(new GridData(GridData.FILL_BOTH));
        ...
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_name);
        UIUtils.createTableColumn(table, SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_description);
        ...
        table.addPaintListener(e -> {
            if (table.getItemCount() == 0) {
                UIUtils.drawMessageOverControl(table, e, UIDashboardMessages.dashboard_add_dialog_over_control_message + viewConfiguration.getDataSourceContainer().getDriver().getName(), 0);
            }
        });
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        final Button managerButton = createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.dashboard_add_dialog_manager_button, false);
        ...
        createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.dashboard_add_dialog_cancel_button, false);
    }
