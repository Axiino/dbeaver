...
public class DashboardDatabaseSelectDialog extends BaseDialog {
    ...
    public DashboardDatabaseSelectDialog(Shell shell) {
        super(shell, UIDashboardMessages.dashboard_database_select_dialog_window_name, null);
    }
    ...
    protected Composite createDialogArea(Composite parent) {
...

        {
            ...
            UIUtils.createTreeColumn(treeViewer.getTree(), SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_name); //reusing of strings
            UIUtils.createTreeColumn(treeViewer.getTree(), SWT.LEFT, UIDashboardMessages.dashboard_add_dialog_table_description);
